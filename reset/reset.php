...
<br>
<div class="login">
    <form action="emailotp.php">
        <label for="fname">Email</label><br>
            <div class="input-container">
                <i class="fas fa-envelope" style="position: absolute; left: 10px;top: 18%; transform: translateY(-50%); "></i>
               
                <input type="text" id="email" name="email" placeholder="@gmail.com" style="padding-left: 30px;" required>
